...
public class FavoritTvAdapater extends RecyclerView.Adapter<FavoritTvAdapater.ViewHolder> {

    private Context context;
    private List<ResultsTv> listitem;

    public FavoritTvAdapater(Context context, List<ResultsTv> resultsTv) {
    ...
    @NonNull
    @Override
    public FavoritTvAdapater.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_favorit, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final FavoritTvAdapater.ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(v -> {
            ...
            intent.putExtra(DetailTvActivity.EXTRATV, listitem.get(viewHolder.getAdapterPosition()));
        ...
        viewHolder.itemView.setOnLongClickListener(v -> {
            ...
            dialog.setPositiveButton(R.string.ya, (dialog1, which) -> {
                dialog1.dismiss();
            ...
            dialog.setNegativeButton(R.string.tidak, (dialog12, which) -> dialog12.dismiss());
            dialog.show();
            return true;
        });
    }
