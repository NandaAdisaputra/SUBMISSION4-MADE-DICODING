package com.nandaadisaputra.cataloguemovie.model.movie;
...
@Entity(tableName = "tb_movie")
 public class ResultsMovie implements Parcelable {
    ...
    @SuppressLint("NewApi")
    public static ResultsMovie fromContentValues(ContentValues values) {
        final ResultsMovie movie = new ResultsMovie();
    ...
    protected ResultsMovie(Parcel in) {
