package com.nandaadisaputra.cataloguemovie.providers;
...
import com.nandaadisaputra.cataloguemovie.roomdatabase.movie.MovieDao;
...
public class MovieProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.nandaadisaputra.cataloguemovie.providers.providers";
        ...
        switch (MATCHER.match(uri)) {
            case CODE_MOVIE_DIR:
                ...
                final long id = MovieDatabase.getMovieDatabase(context).movieDao()
                        .insert(ResultsMovie.fromContentValues(values));
